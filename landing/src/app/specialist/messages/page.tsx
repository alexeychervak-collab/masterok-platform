  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <div className="mb-6">
          <h1 className="text-3xl font-bold">Сообщения специалиста</h1>
          <p className="text-gray-600">Чат + файлы + статусы сообщений. Подготовлено для real-time (WebSocket).</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-4 border-b border-gray-100">
              <div className="relative">
                ...
                <input className="w-full pl-9 pr-3 py-2.5 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-primary-500" placeholder="Поиск клиентов..." />
              </div>
            </div>
