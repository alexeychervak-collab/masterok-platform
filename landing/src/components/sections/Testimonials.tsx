...
const testimonials = [
  {
    ...
    avatar: null,
    rating: 5,
    text: 'Искала электрика через множество сервисов, но именно на МастерОК нашла настоящего профессионала. Алексей приехал вовремя, сделал всё аккуратно и объяснил, что было не так. Теперь только здесь буду искать мастеров!',
  ...
  },
  {
    ...
    avatar: null,
    rating: 5,
    text: 'После ремонта квартира была в ужасном состоянии. Заказала генеральную уборку через МастерОК — приехала команда из 3 человек, за 4 часа всё вычистили до блеска. Цена адекватная, качество отличное!',
